...
using MediCareConnect.Security;
using MediCareConnect.Data;
using Microsoft.Extensions.Logging;
using MedicareConnect.Data;

namespace MediCareConnect.Data.Services
{
    public class UserServiceDb : IUserService
    {
        private readonly MediCareContext  ctx;
      
        public UserServiceDb(MediCareContext ctx) 
        {
            this.ctx = ctx; 
        }
        ...
        Paged<User> IUserService.GetUsers(int page, int size, string orderBy, string direction)
        {
